...
export default function MarketplaceHomePage() {
  ...
  const [activeCat, setActiveCat] = useState<MarketplaceCategory | null>(null);
  ...
  return (
    <>
            ...
            <div className="lg:col-span-5">
              <div className="grid grid-cols-2 gap-2 lg:grid-cols-2">
                <HowCard
                  step="01"
                  title="Choose"
                  body="Browse services or use AI to route."
                />
                <HowCard
                  step="02"
                  title="Confirm"
                  body="Add property, scope, urgency."
                />
                <HowCard
                  step="03"
                  title="Book or quote"
                  body="Direct booking or AED 100 inspection."
                />
                <HowCard
                  step="04"
                  title="Execute"
                  body="OMEGA-supervised visit and report."
                />
              </div>
            </div>
          </div>
      ...
      <Section className="bare:0 py-10 lg:py-14">
      ...
      <Section className="bare:0 pb-14 lg:pb-20">
        <div className="container-edge">
